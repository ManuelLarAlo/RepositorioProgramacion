...
public class TablaDeMultiplicarSimple {
	...
	public static void main(String[] args) {
		...
		int num = 0;
		try (//Coger número por pantalla
		Scanner sc = new Scanner(System.in)) {
			
			//que el programa se quede en un bucle while hasta que el usuario incluya un número entre 1 y 10
			
			System.out.println("Escribe un numero entre 1 y 10: ");
			
			num = sc.nextInt();
		//nos quedamos en el bucle hasta que el numero sea un numero entre 1 y 10
		while (num<1 || num>10) {
